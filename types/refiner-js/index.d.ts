...
declare function _refiner<T extends keyof Methods>(method: T, ...args: Parameters<Methods[T]>): ReturnType<Methods[T]>;
declare function _refiner<T extends keyof Callbacks>(callback: T, fn: Callbacks[T]): void;
